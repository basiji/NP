	 ...
	 $.ajax({
			...
			success: function(data) {
				...
				case 'enseraf':
					...
					$("#OutputTxt").html('');
					$("#OutputTxt")
							.html('<p style="color:red;font-size:16px"> خطا در ارتباط با بانک صادر کننده کارت، لطفا دقایقی دیگر مجددا امتحان کنید </p> <br> <p style="color:black;font-weight:bold;font-size:16px">' + Math.floor((Math.random() * 10000000) + 1) + '  : شماره پیگیری   </p> <br> <a style="font-family:IRANSans;font-size:18px" href="payamchin://refid/failed"> جهت بازگشت به اپلیکیشن کلیک نمایید </a> ')
